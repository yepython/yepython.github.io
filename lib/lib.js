	...
	updateFileTabs: function() {
		...
		for(var file in PythonIDE.files){
			...
			if(isSelected) {
				...
				html += '<div class="file_item_menu_option" data-action="rename">' + (selectedLang === 'en' ? 'Rename' : 'Перейменувати') + '</div>';

				html += '<div class="file_item_menu_option" data-action="delete">' + (selectedLang === 'en' ? 'Delete file' : 'Видалити файл') + '</div>';
		...
		for(var assetName in PythonIDE.projectAssets) {
			...
			html += '<div class="file_item_menu_option" data-action="preview" data-asset="1">' + (selectedLang === 'en' ? 'Preview' : 'Переглянути') + '</div>';

			html += '<div class="file_item_menu_option" data-action="rename" data-asset="1">' + (selectedLang === 'en' ? 'Rename' : 'Перейменувати') + '</div>';

			html += '<div class="file_item_menu_option" data-action="delete" data-asset="1">' + (selectedLang === 'en' ? 'Delete file' : 'Видалити файл') + '</div>';
