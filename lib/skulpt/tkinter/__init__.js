...
var $builtinmodule = function (name) {
    ...
    return Sk.misceval.chain(
        Sk.importModule("tkinter_colors", false, true), // імпорт визначень кольорів
        function (colorsMod) {
            var mod = {};
            var colorTable = colorsMod.$d._colorTable;
            ...
            function resolveColor(value) {				
                ...
                return colorTable.hasOwnProperty(lower) ? colorTable[lower] : value;
            }
	var tk_colors = colorTable
	var idCount = 0;
	var varCount = 0;
	var firstRoot = 0;
