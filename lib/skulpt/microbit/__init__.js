...
var $builtinmodule = function (name) {
	...
	mod.Image = new Sk.misceval.buildClass(mod, function($gbl, $loc) {
		function makeImg(s) {
			var obj = { lines: s.split(":"), tp$name: "Image" };
			return obj;
		}
		...
		$loc.HEART         = makeImg("09090:99999:99999:09990:00900");
		$loc.HEART_SMALL   = makeImg("00000:09090:09990:00900:00000");
		$loc.HAPPY         = makeImg("00000:09090:00000:90009:09990");
		$loc.SMILE         = makeImg("00000:00000:00000:90009:09990");
		$loc.SAD           = makeImg("00000:09090:00000:09990:90009");
		$loc.CONFUSED      = makeImg("00000:09090:00000:09090:90909");
		$loc.ANGRY         = makeImg("90009:09090:00000:99999:90909");
		$loc.ASLEEP        = makeImg("00000:99099:00000:09990:00000");
		$loc.SURPRISED     = makeImg("09090:00000:00900:09090:00900");
		$loc.SILLY         = makeImg("90009:00000:99999:00909:00999");
		$loc.FABULOUS      = makeImg("99999:99099:00000:09090:09990");
		$loc.MEH           = makeImg("09090:00000:00090:00900:09000");
		$loc.YES           = makeImg("00000:00009:00090:90900:09000");
		$loc.NO            = makeImg("90009:09090:00900:09090:90009");
		$loc.CLOCK12       = makeImg("00900:00900:00900:00000:00000");
		$loc.CLOCK1        = makeImg("00090:00090:00900:00000:00000");
		$loc.CLOCK2        = makeImg("00000:00099:00900:00000:00000");
		$loc.CLOCK3        = makeImg("00000:00000:00999:00000:00000");
		$loc.CLOCK4        = makeImg("00000:00000:00900:00099:00000");
		$loc.CLOCK5        = makeImg("00000:00000:00900:00090:00090");
		$loc.CLOCK6        = makeImg("00000:00000:00900:00900:00900");
		$loc.CLOCK7        = makeImg("00000:00000:00900:09000:09000");
		$loc.CLOCK8        = makeImg("00000:00000:00900:99000:00000");
		$loc.CLOCK9        = makeImg("00000:00000:99900:00000:00000");
		$loc.CLOCK10       = makeImg("00000:99000:00900:00000:00000");
		$loc.CLOCK11       = makeImg("09000:09000:00900:00000:00000");
		$loc.ARROW_N       = makeImg("00900:09990:90909:00900:00900");
		$loc.ARROW_NE      = makeImg("00999:00099:00909:09000:90000");
		$loc.ARROW_E       = makeImg("00900:00090:99999:00090:00900");
		$loc.ARROW_SE      = makeImg("90000:09000:00909:00099:00999");
		$loc.ARROW_S       = makeImg("00900:00900:90909:09990:00900");
		$loc.ARROW_SW      = makeImg("00009:00090:90900:99000:99900");
		$loc.ARROW_W       = makeImg("00900:09000:99999:09000:00900");
		$loc.ARROW_NW      = makeImg("99900:99000:90900:00090:00009");
		$loc.TRIANGLE      = makeImg("00000:00900:09090:99999:00000");
		$loc.TRIANGLE_LEFT = makeImg("90000:99000:90900:90090:99999");
		$loc.CHESSBOARD    = makeImg("09090:90909:09090:90909:09090");
		$loc.DIAMOND       = makeImg("00900:09090:90009:09090:00900");
		$loc.DIAMOND_SMALL = makeImg("00000:00900:09090:00900:00000");
		$loc.SQUARE        = makeImg("99999:90009:90009:90009:99999");
		$loc.SQUARE_SMALL  = makeImg("00000:09990:09090:09990:00000");
		$loc.RABBIT        = makeImg("90900:90900:99990:99090:99990");
		$loc.COW           = makeImg("90009:90009:99999:09990:00900");
		$loc.MUSIC_CROTCHET= makeImg("00900:00900:00900:99900:99900");
		$loc.MUSIC_QUAVER  = makeImg("00900:00990:00909:99900:99900");
		$loc.MUSIC_QUAVERS = makeImg("09999:09009:09009:99099:99099");
		$loc.PITCHFORK     = makeImg("90909:90909:99999:00900:00900");
		$loc.XMAS          = makeImg("00900:09990:00900:09990:99999");
		$loc.PACMAN        = makeImg("09999:99090:99900:99990:09999");
		$loc.TARGET        = makeImg("00900:09990:99099:09990:00900");
		$loc.TSHIRT        = makeImg("99099:99999:09990:09990:09990");
		$loc.ROLLERSKATE   = makeImg("00099:00099:99999:99999:09090");
		$loc.DUCK          = makeImg("09900:99900:09999:09990:00000");
		$loc.HOUSE         = makeImg("00900:09990:99999:09990:09090");
		$loc.TORTOISE      = makeImg("00000:09990:99999:09090:00000");
		$loc.BUTTERFLY     = makeImg("99099:99999:00900:99999:99099");
		$loc.STICKFIGURE   = makeImg("00900:99999:00900:09090:90009");
		$loc.GHOST         = makeImg("99999:90909:99999:99999:90909");
		$loc.SWORD         = makeImg("00900:00900:00900:09990:00900");
		$loc.GIRAFFE       = makeImg("99000:09000:09000:09990:09090");
		$loc.SKULL         = makeImg("09990:90909:99999:09990:09990");
		$loc.UMBRELLA      = makeImg("09990:99999:00900:90900:09900");
		$loc.SNAKE         = makeImg("99000:99099:09090:09990:00000");
